...
import com.hucmuaf.locket_mobile.modeldb.Room;
...
import java.util.Arrays;
 ...
 public class MainActivity extends AppCompatActivity {
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         String roomId = myRef.child("room").push().getKey();
         Room newRoom = new Room(roomId, "camt91990", "friend1", System.currentTimeMillis());

         // Ghi dữ liệu vào node "room"
         myRef.child("room").child(roomId).setValue(newRoom)
